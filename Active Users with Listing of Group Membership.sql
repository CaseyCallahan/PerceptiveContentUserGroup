/*
Perceptive Content Active User List with Listing of Group Membership
...
--select DISTINCT scu.usr_id, scu.usr_last_name, scu.usr_first_name, scu.usr_name, scu.MOBILE_NUM, scu.extern_id, scu.usr_cat, scu.is_deleted, scu.IS_ACTIVE, data.groups
SELECT scu.*, data.groups
...
where IS_ACTIVE = 1 and IS_DELETED = 0 and usr_cat = 0
